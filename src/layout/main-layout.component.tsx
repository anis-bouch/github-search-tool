    ...
    <div className='main-container'>
      <div className='search-header'>
        ...
        <div className='search-header-title'>
          <span className='search-header-title-color--black bold big-font'>Github Searcher</span>
          <span className='search-header-title-color--grey'>search user or repositories below</span>
        </div>
      </div>
