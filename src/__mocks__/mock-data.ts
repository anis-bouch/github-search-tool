import { SuccessActionPayload } from "../feature/search/state/search.types";
...
export const repoData = {
  ...
  owner: {
    ...
    following_url: 'https://api.github.com/users/Haojen/following{/other_user}',
    gists_url: 'https://api.github.com/users/Haojen/gists{/gist_id}',
    starred_url: 'https://api.github.com/users/Haojen/starred{/owner}{/repo}',
    subscriptions_url: 'https://api.github.com/users/Haojen/subscriptions',
    organizations_url: 'https://api.github.com/users/Haojen/orgs',
    repos_url: 'https://api.github.com/users/Haojen/repos',
    events_url: 'https://api.github.com/users/Haojen/events{/privacy}',
    received_events_url: 'https://api.github.com/users/Haojen/received_events',
    type: 'User',
    site_admin: false,
  },
  ...
  forks_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/forks',
  keys_url:
  ...
  teams_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/teams',
  hooks_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/hooks',
  issue_events_url:
    'https://api.github.com/repos/Haojen/hexo-theme-Anisina/issues/events{/number}',
  events_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/events',
  assignees_url:
  ...
  tags_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/tags',
  blobs_url:
  ...
  merges_url: 'https://api.github.com/repos/Haojen/hexo-theme-Anisina/merges',
  archive_url:
...
export const userData = {
  ...
  following_url: 'https://api.github.com/users/anis/following{/other_user}',
  gists_url: 'https://api.github.com/users/anis/gists{/gist_id}',
  starred_url: 'https://api.github.com/users/anis/starred{/owner}{/repo}',
  ...
  received_events_url: 'https://api.github.com/users/anis/received_events',
  type: 'User',
  site_admin: false,
  score: 1,
};
...
export const payloadFromFetchUsersAPI = {
  repos: [],
  searchBy: 'user',
  searchTerm: 'anis',
  users: [userData],
...
export const payloadFromFetchReposAPI = {
  users: [],
  searchBy: 'repository',
  searchTerm: 'theme',
  repos: [
...
export const mockedReponseFromAxiosGetUsers = {
...
export const mockedReponseFromAxiosGetRepo = {
  incomplete_results: false,
  total_count: 1,
  items: [
    repoData,
...
export const mockedStoreForFetchingUserFromLocal = {
  error: {
    code: 0,
    message: '',
  },
  ...
  previousSearchesUsers: ['ani', 'anis'],
...
export const mockedStoreForFetchingRepoFromLocal = {
  error: {
    code: 0,
    message: '',
  },
